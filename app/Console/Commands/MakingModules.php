...
class MakingModules extends Command
{
    ...
    public function handle()
    {
      //  $wos = sub_str($module,0,-1); // wos => With Out S
        ...
        Artisan::call("make:import " . ucfirst($module) ."Import --model=" . $module);
        $this->info("Excel Import Created!");

        Artisan::call("make:export " . ucfirst($module) ."Export --model=" . $module);
        $this->info("Excel Export Created!");
